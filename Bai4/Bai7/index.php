...
<head>
    <meta charset="UTF-8">
    <title>Bài 7.7 :Function</title>
    <link rel="stylesheet" href="/BAITAPWEB/Bai4/Bai7/css/style.css">
</head>
                ...
                <div class="content-right">
                    ...
                    switch ($page) {
                        ...
                        case "matrix":
                            ...
                            break;
                        case 'associationarray':
                            include "./pages/associationarray.php";
                            break;
                        default:
                            include "./pages/home.php";
                            break;
