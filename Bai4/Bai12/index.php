...
<head>
    <meta charset="UTF-8">
    <title>Bài 7.12: Truy vấn dữ liệu</title>
    <link rel="stylesheet" href="/BAITAPWEB/Bai4/Bai12/css/style.css">
</head>
        ...
        <div class="content">
            ...
            <div class="center">
                ...
                <div class="content-right">
                    ...
                    switch ($page) {
                        case "ListClass":
                            include "./Pages/ListClass.php";
                            break;
                        case "listStudentsInClass":
                            include "./Pages/listStudentsInClass.php";
                            break;
                        case "studentDetail":
